...
/// Since Stories is a static framework, a cut down framework is embedded, with all the resources but only a stub Mach-O image.
    static let module: Bundle = {
        ...
        ].map({ $0?.appendingPathComponent("Stories.framework") })
        ...
        for candidate in bundleCandidates {
            let bundlePath = candidate?.appendingPathComponent("TypingKids_Stories.bundle")
...
@objc
public final class StoriesResources: NSObject {
